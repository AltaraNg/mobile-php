                                    ...
                                    <div style="width:100% !important;">
                                        ...
                                        <div
                                            ...
                                            <div class="button-container" align="left"
                                                ...
                                                <p>
                                                    A request has been made to perform a credit check on
                                                    {{ $customer_name }}, who has applied for
                                                </p>
                                                <div class="customer">
                                                    <h3>Product Information</h3>
                                                    <p><b>Product name:</b> {{ $product_name }}</p>
                                                    <p><b>Product price number:</b> {{ $product_price }}</p>
                                                </div>

                                                <div class="customer">
                                                    <h3>Customer Information</h3>
                                                    <p><b>Customer name:</b> {{ $customer_name }}</p>
                                                    <p><b>Customer phone number:</b> {{ $customer_phone_number }}</p>
                                                </div>


                                                <p>
                                                    To access the customer's information, please use the following link
                                                    <a href="{{ $url }}" target="_blank">View Pending
                                                        Credit Check</a>
                                                </p>
                                                <p>
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        If you have any questions, don't hesistate to reach out to us
                                                    </p>
